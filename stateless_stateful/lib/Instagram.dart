                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            _buildProfileStat("Posts", "9"),
                            _buildProfileStat("Followers", "999"),
                            _buildProfileStat("Following", "1"),
                          ],
                        ),
                        SizedBox(height: 8),
                      ],
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: CircleAvatar(
              radius: 12,
              backgroundImage: CachedNetworkImageProvider('https://picsum.photos/id/1005/100'),
            ),
            label: '',
          ),
        ],
